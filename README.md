...
**一只正侧面的企鹅**（造型语言按实拍与参考矢量图复刻），**三个品种可切**：

| 品种 | 特征 |
|---|---|
| **巴布亚企鹅**（默认） | 眼睛后上方一块椭圆白斑（手工微调到 `cx 56.8 / cy 17.3 / rx 4.4 / ry 7.9 / -29°`）、红色长喙（喙脊黑线 + 喙尖黑钩 + 喙基黑带）、橘色三趾蹼足带**黑爪** |
| **阿德利企鹅** | 低平的全黑头顶、**细白眼圈**、短而暗的喙、纤细直立的躯干、更窄的白胸、修长的下垂鳍肢、暗粉灰蹼足、向后拖出的长硬尾 |
| **帝企鹅** | 近黑炭灰外套、颈侧一块**黄色泪滴状耳斑**、**淡奶黄上胸渐入白腹**、细长的暗喙、灰黑蹼足 |

在 **设置 → 企鹅乐园 → 品种** 里切换，立刻生效；姿态、走路、拉屎、游泳全部照旧，只换皮肤
（实现方式是对造型串做定向替换，见「更新记录 1.5.0」）。
